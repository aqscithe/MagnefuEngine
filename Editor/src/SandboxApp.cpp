...
struct ObjScene : public Magnefu::Scene 
{
	...
	void                                    load(cstring filename, cstring path, Magnefu::Allocator* resident_allocator, Magnefu::StackAllocator* temp_allocator, Magnefu::AsynchronousLoader* async_loader_);
	void                                    free_gpu_resources(Magnefu::Renderer* renderer);
	void                                    unload(Magnefu::Renderer* renderer);
...
void ObjScene::load(cstring filename, cstring path, Magnefu::Allocator* resident_allocator, Magnefu::StackAllocator* temp_allocator, Magnefu::AsynchronousLoader* async_loader_)
{
    using namespace Magnefu;
