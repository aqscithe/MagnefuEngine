...
//layout(location = 3) out vec3 TangentLightPos[3];
...
void main()
{
    ...
    {
        TangentLightPos[i] = TBN * globals_ubo.LightPos[i];
    }*/
...
//layout(location = 3) in vec3 TangentLightPos[3];
