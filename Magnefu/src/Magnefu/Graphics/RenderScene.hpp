...
namespace Magnefu {
    ...
    struct RenderScene {
        ...
        void                    on_resize(GraphicsContext& gpu, FrameGraph* frame_graph, u32 new_width, u32 new_height);
        ...
        u32                     volumetric_fog_box_color = Magnefu::Color::green;
    ...
    struct DrawTask : public enki::ITaskSet {
        ...
        void init(GraphicsContext* gpu_, FrameGraph* frame_graph_, Renderer* renderer_,
