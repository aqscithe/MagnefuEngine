...
namespace Magnefu {
    ...
    void CommandBuffer::reset() {
        ...
        for (u32 i = 0; i < resource_count; ++i) {
            ...
            if (v_descriptor_set) {
                ...
                mffree(v_descriptor_set->resources, gpu_device->allocator);
            }
        ...
        //if ( !is_recording )
        {
            ...
            if (render_pass != current_render_pass) {
                if (gpu_device->dynamic_rendering_extension_present) {
                    ...
                    u64 marker = gpu_device->temporary_allocator->getMarker();
    ...
    void CommandBuffer::upload_texture_data(TextureHandle texture_handle, void* texture_data, u32 texture_size, BufferHandle staging_buffer_handle, sizet staging_buffer_offset, Array<MipInfo>& mips) {
