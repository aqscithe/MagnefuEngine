...
namespace Magnefu {
    ...
    void util_add_image_barrier(GraphicsContext* gpu, VkCommandBuffer command_buffer, VkImage image, ResourceState old_state, ResourceState new_state, u32 base_mip_level, u32 mip_count, bool is_depth) {
