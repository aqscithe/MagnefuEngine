...
namespace Magnefu {
    ...
    struct CommandBuffer {
        ...
        // Non-drawing methods
        void                            upload_texture_data(TextureHandle texture, void* texture_data, u32 texture_size, BufferHandle staging_buffer, sizet staging_buffer_offset, Array<MipInfo>& mips);
