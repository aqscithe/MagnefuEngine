...
namespace Magnefu
{
	...
	SamplerInfo Texture::s_ImageTexSamplerInfo = { VK_NULL_HANDLE, 0 };
	SamplerInfo Texture::s_DataTexSamplerInfo = { VK_NULL_HANDLE, 0 };


	Texture::Texture(const TextureDesc& desc) : Texture(desc)
	{
		switch (desc.Type)
		{
	...
	void Texture::CreateTextureImage(const TextureDesc& desc)
	{
