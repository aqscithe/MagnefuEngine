...
namespace Magnefu
{
	...
	void DoFPass::on_resize(GraphicsContext& gpu, u32 new_width, u32 new_height)
	{
		u32 w = new_width;
		u32 h = new_height;
	...
	void glTFDrawTask::init(GraphicsContext* gpu_, FrameGraph* frame_graph_, Renderer* renderer_, ImGuiService* imgui_, GPUProfiler* gpu_profiler_, glTFScene* scene_)
	{
        gpu = gpu_;
        frame_graph = frame_graph_;
        renderer = renderer_;
