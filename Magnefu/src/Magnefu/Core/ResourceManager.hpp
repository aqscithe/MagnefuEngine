...
namespace Magnefu
{
    ...
    struct Resource 
    {
        ...
        void            remove_reference() { MF_CORE_ASSERT(references != 0, "No references"); --references; }
    ...
    struct ResourceLoader
    {
        ...
        virtual Resource* create_from_file(cstring name, cstring filename, Magnefu::ResourceManager* resource_manager) { return nullptr; }
